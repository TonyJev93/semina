...
<p>위 그림은 하이퍼레저 패브릭 공식 사이트에서 제공해주는 패브릭 블록체인 네트워크 구성도 Sample입니다.</p>
<ul>
<li>
...
<h2 id="소개">소개</h2>
<p><strong>LALP</strong>(Lotte Agile Ledger Platform)은 롯데정보통신 표준 블록체인 플렛폼입니다. 해당 플렛폼은 위에서 설명한 <strong>하이퍼레저 패브릭 네트워크를 손쉽게 구성할 수 있도록 지원</strong>해준다.</p>
...
<blockquote>
<p><strong>플렛폼 사용 없이</strong> 패브릭 네트워크 구성할 때의 문제점</p>
<ul>
<li>큰 진입장벽</li>
<li>명령어 직접 작성</li>
<li>떨어지는 가시성</li>
