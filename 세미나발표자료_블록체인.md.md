...
<p><strong>3.</strong> LALP 플랫폼 이용을 통한 패브릭 네트워크 구성하기</p>
<ul>
<li>LALP 소개</li>
<li>네트워크 구성하기</li>
</ul>
<h1 id="블록체인-종류">1. 블록체인 종류</h1>
...
<li>개방형과 허가형 블록체인을 서로 연결하거나 섞은 <strong>하이브리드(Hybrid) 블록체인</strong></li>
</ol>
<p>이 중 대중적으로 비트코인으로 널리 알려져 있는 <strong>개방형 블록체인</strong>과 기업에서 활발하게 사용하는 <strong>허가형 블록체인</strong>의 대표적인 차이점을 간단하게 알아보도록 하겠습니다.</p>
...
</table><h1 id="허가형-블록체인---하이퍼레저-패브릭이란">2. 허가형 블록체인 - 하이퍼레저 패브릭이란?</h1>
<p><strong>하이퍼레저</strong>(Hyperledger)는 리눅스 재단이 주도하는 <strong>기업용 블록체인 기술</strong> 개발을 위한 <strong>오픈소스 프로젝트</strong>입니다.</p>
<p>해당 프로젝트는 <strong>6개의 프레임 워크</strong>와 <strong>5개의 툴</strong>을 포함하고 있습니다.</p>
<ul>
<li><strong>프레임 워크</strong> : Beus, Burrow, <strong>Fabric</strong>, Indy, Iroha, Sawtooth</li>
<li><strong>툴</strong> : Avalon, Cactus, Caliper, Cello, <strong>Explorer</strong></li>
</ul>
<p>이 중 <strong>하이퍼레저 패브릭</strong>(이하 패브릭)은 6개의 프레임워크 중 하나로 현재 가장 활발하게 개발되고 있는 <strong>분산원장기술 플랫폼</strong>(DLT)입니다.</p>
<p><strong>패브릭</strong>은 초기 IBM이 제공한 코드를 기반으로 수많은 개발자가 참여하고 있으며 구글, 아마존, 오라클 등의 여러 기업들이 활용하고 있는 <strong>허가형 블록체인 프로젝트</strong>이다.</p>
<h2 id="특징">특징</h2>
<ol>
<li>허가형 블록체인으로 허가 받은 참여자만이 네트워크에 참여할 수 있다.</li>
<li>일부 노드만 스마트 컨트랙트를 설치하여 거래를 병렬적으로 빠르게 처리할 수 있다.</li>
<li>다중 채널을 통해 장부의 기밀성을 유지할 수 있다.</li>
<li>교체 가능한 합의 프로토콜을 사용할 수 있다. ( SOLO, Kafka … )</li>
</ol>
