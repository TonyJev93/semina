...
<p><strong>2.</strong> 기업형 블록체인 - 하이퍼레저 패브릭이란?</p>
<ul>
<li>특징</li>
<li>네트워크 구성도</li>
</ul>
...
</table><h1 id="기업형-블록체인---하이퍼레저-패브릭이란">2. 기업형 블록체인 - 하이퍼레저 패브릭이란?</h1>
<p><strong>하이퍼레저</strong>(Hyperledger)는 리눅스 재단이 주도하는 <strong>기업용 블록체인 기술</strong> 개발을 위한 <strong>오픈소스 프로젝트</strong>입니다.</p>
<p>해당 프로젝트는 <strong>6개의 프레임 워크</strong>와 <strong>5개의 툴</strong>을 포함하고 있으며,</p>
<ul>
...
<p>이 중 <strong>하이퍼레저 패브릭</strong>(Hyperledger fabric)은 5개의 프레임워크 중 하나로 현재 <strong>가장 활발하게 개발되고 있는 분산원장기술 플랫폼</strong> 입니다.</p>
<h2 id="특징">특징</h2>
